...
public class TokenProvider {
    ...
    public String createToken(Authentication authentication) {
        ...
        User user = userRepository.findById(userPrincipal.getId()).orElseThrow(() -> new UsernameNotFoundException("User not found with id: " + userPrincipal.getId()));
        user.setToken(jwt);
        User updatedUser = userRepository.save(user);

        System.out.println("create token: " + updatedUser);
        return jwt;
    }
